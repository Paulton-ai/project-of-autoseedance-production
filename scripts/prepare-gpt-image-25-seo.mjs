...
// Keep the existing /tools/image URL as the single canonical image generator.
// This build-time transform upgrades its SEO without creating a duplicate page.
source = source
  .replace(
    /\{ title: "[^"]*" \},/,
    '{ title: "GPT Image 2.5 Free Online – Flare & Sunburst AI Image Generator | Auto Seedance" },',
  )
  .replace(
  ...
  // Google ignores meta keywords; remove the old keyword tag rather than stuffing terms.
  ...
  .replace(
    ...
    '{ name: "twitter:title", content: "GPT Image 2.5 Free Online – Flare & Sunburst | Auto Seedance" },',
  )
  .replace(
    /\{ name: "twitter:description", content: "[^"]*" \},/,
    '{ name: "twitter:description", content: "Generate AI images online with GPT Image 2.5 Flare and Sunburst on Auto Seedance." },',
  );

// Remove unsupported/fake aggregate-rating markup. Do not manufacture reviews or ratings.
source = source.replace(/\n\s*aggregateRating: \{ "@type": "AggregateRating", ratingValue: "4\.9", ratingCount: "850" \},/, "");

// Remove the old FAQ structured-data block. The visible FAQ remains useful content, but
// Google FAQ rich results are not the target here and the old answers contained stale credit claims.
...
// Update the visible tool heading and subtitle while keeping the existing generator UI.
source = source.replace(
...
// Add concise, crawler-visible topical content directly to the existing generator page.
// It intentionally targets both the product phrase and both API model names without creating new URLs.
const seoSection = `
            ...
            <div className="max-w-4xl space-y-7">
              <div>
                ...
                <p className="mt-3 text-muted-foreground leading-7">
                  Create images online with GPT Image 2.5 on Auto Seedance. Enter a prompt above to generate visuals with the new GPT Image 2.5 models, including GPT Image 2.5 Flare and GPT Image 2.5 Sunburst.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground leading-7">
                  GPT Image 2.5 Flare is designed for fast, high-quality everyday image generation. It is a strong choice for social media graphics, thumbnails, product concepts, visual ideas, and quick creative iterations.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground leading-7">
                  GPT Image 2.5 Sunburst is designed for detailed creative work where more precision is useful. Use it for polished visual concepts, detailed layouts, product imagery, and prompts that need tighter control.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground leading-7">
                  GPT Image 2.5 can be used for AI art, realistic visuals, illustrations, product concepts, social media content, YouTube thumbnails, posters, and other creative image projects. Auto Seedance provides the generator in the browser so you can move from a text prompt to an image without leaving this page.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 space-y-4 text-muted-foreground leading-7">
                  <div>
                    <h3 className="font-semibold text-foreground">What is GPT Image 2.5?</h3>
                    <p className="mt-1">GPT Image 2.5 is OpenAI's newer image-generation family. The API includes GPT Image 2.5 Flare and GPT Image 2.5 Sunburst, while ChatGPT uses the ChatGPT Images 2.5 product experience.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground">What is the difference between Flare and Sunburst?</h3>
                    <p className="mt-1">Flare is the faster everyday option, while Sunburst is intended for premium visual workflows that benefit from tighter control and more precision.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground">Can I use GPT Image 2.5 online?</h3>
                    <p className="mt-1">Yes. You can use the GPT Image 2.5 models available in Auto Seedance directly from this image generator page.</p>
                  </div>
                </div>
              </div>
            </div>
...
// Refresh visible FAQ copy so it matches the current product instead of the old 50-credit claim.
source = source.replace(

...
export const Route = createFileRoute("/tools/video")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.autoseedance.site/tools/video" },
    ...
    links: [{ rel: "canonical", href: "https://www.autoseedance.site/tools/video" }],
    scripts: [
      {
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Video Generator", item: "https://www.autoseedance.site/tools/video" },
          ],
        }),
      },
    ],

            ...
            <div className="relative group">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible focus-within:opacity-100 focus-within:visible transition">
                <div className="w-56 rounded-xl border border-border bg-background/95 backdrop-blur shadow-lg overflow-hidden">
                  <Link to="/ai-image-generator" className="flex items-center gap-2 px-4 py-3 hover:bg-muted transition"><ImageIcon className="size-4 text-muted-foreground" /> Image Generation</Link>
                  <Link to="/ai-video-generator" className="flex items-center gap-2 px-4 py-3 hover:bg-muted transition"><Video className="size-4 text-muted-foreground" /> Video Generation</Link>
                  <Link to="/ai-reel-generator" className="flex items-center gap-2 px-4 py-3 hover:bg-muted transition"><Film className="size-4 text-muted-foreground" /> Reel Generator</Link>
                </div>
              </div>
            </div>
